...
public class ExemploLexer {
    ...
    public static void menu(){
        ...
        System.out.println("Pressione '0' para ver sair");
    }

    public static void main (String[] args){
        menu();
        int opcao = Integer.parseInt(entrada.nextLine());
        String filename = "C:\\Users\\User\\Documents\\Aulas\\PROGRAMAÇÃO\\COMPUTADOR\\COMPILADORES\\EXERCICIOS\\CompiladorDeAcrobat\\CompiladorDeAcrobat\\semanticaTestes.txt";
