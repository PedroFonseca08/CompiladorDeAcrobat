...
public class testeParser extends Parser {
	...
	public static class PruleContext extends ParserRuleContext {
		public TerminalNode CHAR() { return getToken(testeParser.CHAR, 0); }
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof testeListener ) ((testeListener)listener).enterPrule(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof testeListener ) ((testeListener)listener).exitPrule(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof testeVisitor ) return ((testeVisitor<? extends T>)visitor).visitPrule(this);
